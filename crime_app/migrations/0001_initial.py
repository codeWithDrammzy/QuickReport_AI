# Generated by Django 5.2.4 on 2026-03-16 21:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ai_priority_suggestion', models.CharField(blank=True, choices=[('Low', 'Low'), ('Medium', 'Medium'), ('High', 'High'), ('Emergency', 'Emergency')], help_text='AI-suggested priority based on description analysis', max_length=20, null=True)),
                ('ai_priority_confidence', models.FloatField(default=0.0, help_text='Confidence score for AI priority suggestion (0-100)')),
                ('ai_incident_suggestion', models.CharField(blank=True, help_text='AI-suggested incident type based on description', max_length=50, null=True)),
                ('ai_incident_confidence', models.FloatField(default=0.0, help_text='Confidence score for AI incident suggestion (0-100)')),
                ('ai_analysis_data', models.TextField(blank=True, help_text='JSON field storing detailed AI analysis results', null=True)),
                ('ai_analyzed_at', models.DateTimeField(blank=True, help_text='Timestamp when AI last analyzed this report', null=True)),
                ('ai_matched_keywords', models.TextField(blank=True, help_text='JSON field storing keywords that triggered AI suggestions', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('notification_type', models.CharField(choices=[('status_update', 'Status Update'), ('reminder', 'Reminder'), ('general', 'General'), ('ai_insight', 'AI Insight')], default='general', max_length=20)),
                ('title', models.CharField(max_length=200)),
        ...
        migrations.AddIndex(
            model_name='crimereport',
            index=models.Index(fields=['ai_priority_suggestion', 'date_reported'], name='crime_app_c_ai_prio_5a5335_idx'),
        ),
    ]
